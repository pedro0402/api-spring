package com.pedro.jpa.libraryapi.controller.common;

import com.pedro.jpa.libraryapi.dto.ErroCampo;
import com.pedro.jpa.libraryapi.dto.ErroResposta;
...
public class GlobalExceptionHandler {
    ...
    public ErroResposta handleErrosNaoTratados(RuntimeException e) {
        return new ErroResposta(HttpStatus.INTERNAL_SERVER_ERROR.value(), "Erro inesperado.", List.of());
    }
